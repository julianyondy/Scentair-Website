...
export const WhatsAppButton: React.FC = () => {
  ...
  return (
    <button
      ref={buttonRef}
      className="fixed z-50 bg-white rounded-full shadow-lg px-4 py-2 text-sm transition-transform duration-300 hover:scale-105 flex items-center gap-2 cursor-move"
      style={{
        left: `${position.x}px`,
        top: `${position.y}px`,
      }}
