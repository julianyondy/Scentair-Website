        ...
        <div className="relative z-10 h-full flex flex-col md:flex-row items-center justify-center gap-y-12 md:gap-x-16 px-6 md:px-16 py-16">
          ...
          <div className="w-full md:w-3/5 h-full flex justify-center">
            <div className="relative w-full max-w-2xl h-96 md:h-[500px]">
              ...
              <div className="absolute -bottom-6 -right-6 rounded-xl shadow-lg p-4 w-40 border-l-4 border-cyan-500 z-20 animate-fadeInSlide">
              ...
              <div className="absolute top-1/4 -left-12 rounded-xl shadow-lg p-4 w-40 border-l-4 border-cyan-500 z-20 animate-fadeInSlide">
              ...
              <div className="absolute top-0 right-0 rounded-xl shadow-lg p-4 w-40 border-l-4 border-cyan-500 z-20 animate-fadeInSlide">
